...
var _SearchBar = __webpack_require__(/*! ./SearchBar */ "./js/Components/SearchBar.js");

var _CatTable = __webpack_require__(/*! ./CatTable */ "./js/Components/CatTable.js");
...
var App = exports.App = function (_React$Component) {
    ...
    function App(props) {
        ...
        _this.handleOnChangeFilter = function (event) {
            _this.setState({
                filterText: event.target.value
            });
        };

        _this.handleOnChangeCheckbox = function (event) {
            _this.setState({
    ...
    _createClass(App, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_CatTable.CatTable, { kitties: this.kitties
                })
            );
        }
    }, {
        ...
        get: function get() {
            ...
            var regex = new RegExp(this.state.filterText);
            return this.props.kitties.filter(function (item) {
                return (!_this2.state.likesKids || item.likesKids === _this2.state.likesKids) && regex.test(item.name);
            });
        }
    }]);
...
var _CatRow = __webpack_require__(/*! ./CatRow */ "./js/Components/CatRow.js");
...
var CatTable = exports.CatTable = function (_React$Component) {
    ...
    _createClass(CatTable, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    this.female.map(function (femaleKitty) {
                        return _react2.default.createElement(_CatRow.CatRow, { kitty: femaleKitty });
                    })
                )
            );
        }
        ...
        key: 'male',
        get: function get() {
            return this.props.kitties.filter(function (kitty) {
                return kitty.category === 'male';
            }) || [];
        }
    }, {
        key: 'female',
...
var SearchBar = exports.SearchBar = function (_React$Component) {
    ...
    function SearchBar() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SearchBar.__proto__ || Object.getPrototypeOf(SearchBar)).call.apply(_ref, [this].concat(args))), _this), _this.handleSearchChange = function (event) {}, _temp), _possibleConstructorReturn(_this, _ret);
    }
...
var _App = __webpack_require__(/*! ./Components/App */ "./js/Components/App.js");
